package fr.esipe.clientservices.user.controllers;

import fr.esipe.clientservices.user.models.UserDto;
import fr.esipe.restservices.utils.AccessClient;
...
public class UserController {
	...
	public ResponseEntity<UserDto> get(@PathVariable Long id) {
		// TODO
		String getUrl = "http://localhost:8080/users/" + id;
		final Optional<UserDto> dtoOpt = Optional.of(new UserDto());
		AccessClient ac = new AccessClient();
		UserDto user = ac.getEntity(getUrl,UserDto.class);
